  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <h1 className="text-3xl font-bold mb-6">Políticas de Privacidade do AnonShare</h1>

        <div className="space-y-6 text-zinc-300">
          <section>
            <h2 className="text-xl font-semibold mb-2">1. Introdução</h2>
            <p>
              O AnonShare está comprometido em proteger sua privacidade. Esta Política de Privacidade explica como
              coletamos, usamos e protegemos suas informações pessoais ao usar nosso serviço de compartilhamento de
              arquivos.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 mt-2">
              ...
              <li>Metadados dos arquivos compartilhados (excluindo o conteúdo do arquivo)</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">6. Cookies e Tecnologias Similares</h2>
            <p>
              Usamos cookies e tecnologias similares para melhorar a experiência do usuário e analisar o uso do serviço.
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacidade@anonshare.com" className="text-blue-400 hover:underline">
