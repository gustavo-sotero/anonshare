			...
			<main className="flex-grow container mx-auto px-4 py-8">
				...
				<div className="space-y-6 text-zinc-300">
					<section>
						...
						<p>
							Ao utilizar o AnonShare, você concorda em cumprir e ficar
					...
					<section>
						...
						<p>
							O AnonShare é uma plataforma de compartilhamento de arquivos que
							permite aos usuários fazer upload e compartilhar arquivos de forma
							anônima.
						</p>
					</section>
					...
					<section>
						...
						<p>
							Embora nos esforcemos para manter o anonimato dos usuários, não
							podemos garantir anonimato completo. Você é responsável por
							qualquer informação pessoal que possa estar contida nos arquivos
					...
					<section>
						...
						<p>
							O AnonShare não é responsável pelo conteúdo compartilhado pelos
							usuários ou por quaisquer danos resultantes do uso do nosso
							serviço.
						</p>
					</section>
					...
					<section>
						...
						<p>
							...
							publicação dos termos atualizados.
						</p>
					</section>
